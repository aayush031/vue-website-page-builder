...
const component: Components[] = [
  {
    components: {
      data: [
        // Naviation Section
        {
          title: 'Navbar With Badge',
          html_code: `<section>\n<div class="pbx-bg-white pbx-border-b pbx-border-gray-100">\n<div class="pbx-mx-auto pbx-max-w-7xl pbx-px-4 lg:pbx-px-4">\n<div class="pbx-flex pbx-items-center pbx-justify-between pbx-py-4">\n\n<div class="pbx-flex pbx-items-center pbx-gap-3">\n<div class="pbx-font-bold pbx-text-xl pbx-text-black">\n<p>YourBrand</p>\n</div>\n<div class="pbx-hidden sm:pbx-flex pbx-items-center pbx-bg-green-100 pbx-text-green-800 pbx-text-xs pbx-font-semibold pbx-px-2 pbx-py-1">\n<p>v2.0 New</p>\n</div>\n</div>\n\n<div class="pbx-hidden lg:pbx-flex pbx-items-center pbx-gap-8">\n<div class="pbx-text-sm pbx-font-medium pbx-text-gray-600">\n<p><a href="#" rel="noopener noreferrer">Features</a></p>\n</div>\n<div class="pbx-text-sm pbx-font-medium pbx-text-gray-600">\n<p><a href="#" rel="noopener noreferrer">Use Cases</a></p>\n</div>\n<div class="pbx-text-sm pbx-font-medium pbx-text-gray-600">\n<p><a href="#" rel="noopener noreferrer">Pricing</a></p>\n</div>\n<div class="pbx-text-sm pbx-font-medium pbx-text-gray-600">\n<p><a href="#" rel="noopener noreferrer">About Us</a></p>\n</div>\n<div class="pbx-text-sm pbx-font-medium pbx-text-gray-600">\n<p><a href="#" rel="noopener noreferrer">Contact</a></p>\n</div>\n</div>\n\n<div class="pbx-flex pbx-items-center pbx-gap-3">\n<div class="pbx-hidden lg:pbx-flex pbx-items-center pbx-border pbx-border-gray-300 pbx-text-gray-700 pbx-text-sm pbx-font-semibold pbx-px-4 pbx-py-2">\n<p><a href="#" rel="noopener noreferrer">Sign in</a></p>\n</div>\n<div class="pbx-hidden lg:pbx-flex pbx-items-center pbx-bg-gray-900 pbx-text-white pbx-text-sm pbx-font-semibold pbx-px-4 pbx-py-2">\n<p><a href="#" rel="noopener noreferrer">Get started →</a></p>\n</div>\n<div class="lg:pbx-hidden pbx-flex pbx-items-center pbx-text-gray-700 pbx-text-xl">\n<p>☰</p>\n</div>\n</div>\n\n</div>\n</div>\n</div>\n</section>`,
          category: 'Landing Page',
          cover_image: `
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 285.5 32">
      <rect fill="#394152" x="0" y="12" width="36" height="6"/>
      <rect fill="#718096" x="40" y="13" width="18" height="4" rx="2"/>
      <rect fill="#718096" x="70" y="13" width="22" height="4"/>
      <rect fill="#718096" x="98" y="13" width="22" height="4"/>
